...
#
# Second step of the bundle (ADVANCED B1). Unused until the retention step in
# massdriver.yaml is uncommented. Stands in for a legal-hold or backup-vault record
